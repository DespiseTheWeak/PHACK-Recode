...
namespace OFFSETS
{
	...
	void InitOffsets()
	{
		...
		//INTERFACES::cvar->ConsoleColorPrintf(CColor(255, 0, 0, 255), "[PHACK] \n");
		...
		m_IsBombTicking = UTILS::netvar_hook_manager.GetOffset("DT_PlantedC4", "m_bBombTicking");
		m_flC4Blow = UTILS::netvar_hook_manager.GetOffset("DT_PlantedC4", "m_flC4Blow");
		m_bBombDefused = UTILS::netvar_hook_manager.GetOffset("DT_PlantedC4", "m_bBombDefused");
		//m_hBombDefuser = UTILS::netvar_hook_manager.GetOffset("DT_PlantedC4", "m_hBombDefuser");
